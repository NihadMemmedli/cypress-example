...
export const LOGIN = {
  ...
  SUBMIT_BUTTON:
    '#submitLoginBtn, button[type="submit"]:contains("Login"), button[type="submit"]:contains("Sign In")',
...
export const SHIPPING = {
  ...
  PHONE_FIELD:
    '#phone, [name="phone"], [type="tel"], input[class*="phone"], input[placeholder*="phone"]',
  STREET_FIELD:
    'input[name="street"], [name="address"], [class*="street"], [class*="address"], input[placeholder*="street"], input[placeholder*="address"]',
  CITY_FIELD: 'input[name="city"], [class*="city"], input[placeholder*="city"]',
  COUNTRY_DROPDOWN:
    '#countries_dropdown_menu, select[name="country"], select[class*="country"], select',
  SUBMIT_ORDER_BUTTON:
    '#submitOrderBtn, [type="submit"], button[class*="submit"], button[class*="order"], button:contains("Submit"), button:contains("Order")',
};
...
export const FILE_UPLOAD = {
  ...
  SUBMIT_BUTTON:
    'button[type="submit"], [class*="upload-button"], button:contains("Upload"), button:contains("Submit")',
  SUCCESS_MESSAGE:
    '.success-message, .alert-success, [class*="success"], div:contains("Successfully uploaded")',
...
export const COMMON = {
  LOADING_INDICATOR:
    '.loading, .spinner, .loader, [class*="loading"], [class*="spinner"], [aria-busy="true"]',
  SUCCESS_MESSAGE:
    '.success-message, .order-success, .alert-success, [class*="success"], [role="alert"][class*="success"], div:contains("Success")',
  ERROR_MESSAGE:
    '.error-message, .alert-danger, .validation-error, [class*="error"], [role="alert"][class*="danger"], div:contains("Error")',
  MODAL: '.modal, .dialog, .popup, [role="dialog"], [class*="modal"], [class*="popup"]',
  MODAL_CLOSE:
    '.close, .modal-close, .dialog-close, [class*="close"], button[aria-label="Close"], button:contains("×")',
};
