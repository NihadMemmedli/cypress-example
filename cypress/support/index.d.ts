...
declare namespace Cypress {
  interface Chainable {
    ...
    completeShipping(
      addressOrPhone: Record<string, unknown> | string,
      street?: string,
      city?: string,
      country?: string
    ): Chainable<void>;
    ...
    safeClick(
      target: string | Chainable<JQuery<HTMLElement>>,
      options?: Partial<Cypress.Timeoutable & Cypress.Loggable>
    ): Chainable<JQuery<HTMLElement>>;
    /** Start or restore a cached session */
    session<K extends string | unknown[]>(
      id: K,
      fn: () => void,
      options?: Partial<Cypress.SessionOptions>
    ): Chainable<void>;
    /** Attach a file to a file input using cypress-file-upload */
    attachFile(
      fileName: string | { fileContent: Blob; fileName?: string; mimeType?: string },
      options?: any
    ): Chainable<JQuery<HTMLElement>>;
  }
}
